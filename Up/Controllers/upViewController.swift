...
class upViewController: UIViewController {
    ...
    var timedProjects: [timedProject] = [timedProject(description: "accept offer", time: 30), timedProject(description: "spend 2-3 hrs on Up", time: 60), timedProject(description: "accept offer a big time offer and start my next steps", time: 25)]
